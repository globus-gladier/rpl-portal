"""
Django settings for rpl_portal project.
...
from rpl_portal.apps import SEARCH_INDEXES  # noqa
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "rpl_portal" / "templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
LOGGING = {
    ...
    "loggers": {
        ...
        "rpl_portal": {"handlers": ["stream"], "level": "INFO"},
    },
}
